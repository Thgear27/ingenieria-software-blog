...
ha enfrentado dificultades para gestionar su inventario de manera eficiente, lo que ha afectado su capacidad
para planificar la producción y controlar costos. Este proyecto propone la implementación de un sistema
de gestión de inventario que optimice el control de stock, mejorando la capacidad de respuesta ante la
demanda y asegurando la satisfacción de sus clientes.
...
Desarrollar e implementar un software de control de inventario automatizado y centralizado para
Muebles Jhonny E.I.R.L., que ofrezca información detallada y analizada en tiempo real, permita la
generación de alertas de bajo stock y optimice la toma de decisiones estratégicas. El sistema
mejorará la eficiencia operativa, reducirá costos asociados al manejo del inventario y optimizará
la planificación de la producción, contribuyendo a que Muebles Jhonny se consolide como líder en
