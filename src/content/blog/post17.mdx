...
|--------------|-----------------------------|
| **Historia 1:** Registro de Usuario | 1. El formulario permite registro por correo y contraseña, además de la opción de vinculación rápida con Google. <br> 2. El proceso de registro con Google debe completarse en dos pasos o menos. <br> 3. Una vez registrado, el usuario recibe confirmación visible de que el proceso ha sido exitoso y se le redirige a la página de inicio. |
| **Historia 2:** Reserva de Cita en Instagram | 1. El enlace para reservar cita en Instagram debe estar ubicado de manera destacada en la página de inicio y ser claramente accesible. <br> 2. Al hacer clic, el enlace se redirige correctamente al chat de Instagram de la empresa sin interrupciones. <br> 3. La dueña puede registrar manualmente las citas en el sistema una vez confirmadas con el cliente en el chat. |
| **Historia 3:** Visor de Citas | 1. El visor de citas debe mostrar claramente el estado de cada cita (pendiente o confirmada). <br> 2. El sistema permite al administrador actualizar el estado de las citas en tiempo real. |
