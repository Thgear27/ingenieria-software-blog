...
- Historia 4: Cómo dueña, quiero poder registrar la reserva de citas de mis clientes y poder agregar nuevos empleados a mi sistema.
...
| **Historia 3:** | 1. El visor de citas debe mostrar claramente el estado de cada cita (pendiente o confirmada).2. El sistema permite al administrador actualizar el estado de las citas en tiempo real. |
