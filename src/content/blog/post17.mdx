...
| **Historia 3:** Visor de Citas | 1. El visor de citas debe mostrar claramente el estado de cada cita (pendiente o confirmada).2. El sistema permite al administrador actualizar el estado de las citas en tiempo real. |
