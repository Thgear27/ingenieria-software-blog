...
| **Desarrollo y Ejecución**| El equipo de desarrollo trabaja en la implementación de las funcionalidades priorizadas: filtro por estado en reservas, paginación en la sección de reservas, gestión de servicios y adicionales y la edición de la landing page. Cada tarea se asigna a los miembros del equipo, quienes trabajan de manera organizada para asegurar el cumplimiento de los requisitos. | Equipo de Desarrollo                       |
